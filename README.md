...
> **Roll the dice. End the argument. Eat something epic.**
...
## 😤 The Problem (You Know Exactly What This Is)

Every. Single. Night. Without fail. Since the dawn of civilization (probably):

> 🧑 "What do you want for dinner?"
> 👩 "I don't know, what do YOU want?"
> 🧑 "I'm fine with anything."
> 👩 "Okay, how about pasta?"
> 🧑 "Ugh, we had pasta on Tuesday."
> 👩 "That was THREE weeks ago, Kevin."
> 🧑 "What about tacos?"
> 👩 "You say tacos every time."
> 🧑 "Because tacos are ALWAYS the right answer!"
> 👩 *opens Uber Eats for the 4th time this week*
> *(You spend $47 on pad thai and silently resent each other)*

**WhatTheFork ends this madness.** One click. One dice roll. One recipe. Zero arguments. Possibly fewer therapy bills.

---

## ✨ Features (aka "Things This Beautiful Little File Can Do")

### 🎲 The Dice Roller — The Star of the Show
Click the big satisfying dice (or the even bigger "Roll the Fork!" button) and watch it spin dramatically like it's auditioning for a Vegas show. It lands on a random recipe from the library. That's your dinner now. The dice have spoken. There is no appeal process.
...
### ✍️ My Choices Mode — Democracy in the Kitchen
Switch to **"My Choices"** mode and type in the meals you're actually debating. Add as many as you like. The dice picks one at random. Now instead of arguing with each other, you're *both* yelling at the dice. This is called growth.
...
### 📋 Full Recipe Cards — Not Just "Mix Everything Together and Hope"
Every recipe comes with:
- **Ingredient table** with checkboxes — check things off as you grab them and feel like an actual professional
- **Step-by-step instructions** that assume you're a smart adult but also gently beg you not to scramble your carbonara eggs
- **Difficulty badge** so you know if tonight is "I've got this" or "God be with me"
- **Cook time** so you can accurately calculate how late dinner will actually be

### 💡 "Make It Better" Tips — The Upgrade Pack Nobody Asked For But Everyone Needs
...
### 📤 Share with Partner — Pass the Blame Electronically
Click **"📤 Share with Partner"** to either:
- Launch your device's native share sheet (mobile) to send the recipe like a thoughtful, organised human
- Copy it to your clipboard (desktop) so you can paste it into chat and say *"The dice decided. Not me. Not my fault. Take it up with fate."*

### 🖨️ Print Recipe — Going Full Grandma Mode
Hit **"🖨️ Print Recipe"** for a clean, ink-friendly printout. Great for sticking on the fridge, gifting to a friend, or laminating and framing because you're really proud of yourself tonight and honestly you should be.

### 🔄 Nope, Roll Again — The Coward's Exit
Not feeling the dice's divine selection? Hit **"🔄 Nope, Roll Again"** and tempt fate once more. The dice has no feelings. The dice does not remember. But the dice is always watching.
...
## 🚀 Quick Start — It's Literally Just a File

No npm. No webpack. No `node_modules` folder heavier than your self-worth. Just HTML.

```bash
git clone https://github.com/prajitdatta/whatthefork.git
cd whatthefork
open index.html
# Done. That's it. Go cook dinner. Shoo.
```

Want to feel like a real developer by serving it locally?

```bash
npx serve .
# OR the Python way, for those of a certain vintage:
python3 -m http.server 8080
# Then open http://localhost:8080 and feel extremely technical
```

---

## 🗂️ Project Structure — Shockingly, Beautifully Simple

```
whatthefork/
├── index.html     ← EVERYTHING. All the HTML. All the CSS. All the JS.
│                    One file. No drama. No build step. No tears.
...
Find the `RECIPES` array in `index.html` and drop your object at the end. Here's the exact format — copy it, fill it in, submit a PR, become a legend:
...
```javascript
{
  ...
  steps: [
    "Step one. Be clear. Assume the reader is intelligent but also stressed and probably hungry.",
    "Step two. Warn them about the thing they're inevitably about to do wrong.",
    "Step three. Tell them it's ready. They need to hear it.",
    // etc...
  ],
  tips: [
...
## 🛠️ Tech Stack — Or: An Ode to Not Installing Things

| Layer | What | Why |
|-------|------|-----|
| Structure | Semantic HTML5 | Accessibility + SEO. Two birds, one file, zero frameworks. |
| Styling | CSS Custom Properties + Grid/Flexbox | No Tailwind required when you have MDN and two hours to spare. |
| Logic | Vanilla ES6+ JavaScript | Zero dependencies = zero supply chain attacks = zero `npm audit` nightmares at 11pm. |
| Animations | Pure CSS `@keyframes` | No GSAP. No Framer Motion. Just math and vibes. |
| Fonts | Google Fonts (Boogaloo + Nunito) | Because Comic Sans was considered and rejected. |
| Storage | `localStorage` | Browser-native. No database. No server. No Prajit's credit card. |
| Hosting | GitHub Pages | Free. Fast. Forever. The holy trinity. |

No React. No Vue. No Svelte. No Solid. No Astro. No Next. No Nuxt. No build step. No transpiler. No bundler. No monorepo. No Docker. No Kubernetes. No cloud functions. No microservices. **Just a single HTML file that you double-click and it works.** We are at peace.
...
<p align="center"><em>Several dinners were saved. Several relationships, possibly also.</em></p>
